...
typedef struct _TextPart {
    ...
    Boolean heavyCursor;
    Boolean readOnly;
    Boolean dragStartsOnCharacter; /* If drag select start with the character
                                      under the mouse cursor or with the
                                      cursor position set by the mouse cursor */
    Boolean enableQuadrupleClick; /* If quadruple click is allowed. Quadruple 
                                     click will selects all of the text */
    int rows, columns;
    ...
    int emulateTabs;
    char *delimiters;
    char *nonWhiteSpaceDelimiters;
    int selectThreshold;   /* Number of pixels of motion from the initial
                              (grab-focus) button press required to begin 
                              recognizing a mouse drag for the purpose of 
                              making a selection */
    int verticalScrollDelay; /* Length of delay in milliseconds for vertical 
                                autoscrolling */
    ...
    int lastBtnDown;			/* The button that caused the last button
    					   down event for multi-click recognition */
    Time lastBtnDownTime;			/* Timestamp of last button down event
