...
CPP_PROJ=/nologo /ML /W3 /EHsc /O2 /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "_CRT_SECURE_NO_WARNINGS" $(XMSTATICDEF) /Fp"$(INTDIR)\nedit.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_PROJ=/nologo /MD /W3 /EHsc /ZI /Od /I ".." /I "$(MOTIF)\include" /I "$(XDK)\include" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_CRT_SECURE_NO_WARNINGS" $(XMSTATICDEF) /Fp"$(INTDIR)\nedit.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
