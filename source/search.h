...
typedef enum _FindReplaceDlogDefaultButton {
	FIND_REPLACE_NO_BUTTON_DEFAULT, 
	FIND_REPLACE_FIND_BUTTON_DEFAULT, 
	FIND_REPLACE_REPLACE_BUTTON_DEFAULT
} FindReplaceDlogDefaultButton;
